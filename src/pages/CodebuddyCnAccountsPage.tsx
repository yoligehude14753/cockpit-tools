...
const CODEBUDDY_USAGE_URL = 'https://www.codebuddy.cn/profile/usage';
        ...
        {!isFlowNoticeCollapsed && (
          <div className="ghcp-flow-notice-body">
            ...
            <ul className="ghcp-flow-notice-list">
              ...
              <li>{t('codebuddyCn.flowNotice.network', '网络范围：OAuth 授权登录与 Token 刷新需联网请求 codebuddy.cn 与 copilot.tencent.com；配额查询需调用计费 API。不上传本地密钥或凭证。')}</li>
            </ul>
          </div>
        )}
      </div>
